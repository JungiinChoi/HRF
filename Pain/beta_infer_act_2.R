# Setting 2:  Activation beta (only 1 and 0) with 4 parcells 
...
beta1 <- (2*Blist[,4] + Blist[,8]+ Blist[,30]+3.5)/3/2
...
contour(seq(0, 1, length.out = sqrt(n_points)), seq(0, 1, length.out = sqrt(n_points)), 
        matrix((Blist[,4] + Blist[,8]+ Blist[,30]+2.5)/3, nrow = length(seq(0, 1, length.out = sqrt(n_points))), byrow = T),  
        main = "True beta", ylab = "x2")
...
save(beta_DD, sig_hat, tc_mat, file = "beta_inf_sim2.RData")
...
for (j in 1:length(error_sig)){
  ...
  #create plot
  png(paste0("/Users/user/Desktop/sim_figure/setting2/betafit/betafit", j, "-0.png"), width = 500, height = 400)
  ...
  filled.contour(x = fld$x,
                 ...
                 key.title = title(main = "beta1 ", cex.main = 1))
  dev.off()
  png(paste0("/Users/user/Desktop/sim_figure/setting2/diff/diff", j, "-0.png"), width = 500, height = 400)
...
for (j in 1:length(error_sig)){
  ...
  for (bw in 0:3){
    png(paste0("/Users/user/Desktop/sim_figure/setting2/betafit/betafit", j, "-", bw, ".png"), width = 500, height = 400)
    if (bw==0){
  ...
  for (bw in 0:3){
    png(paste0("/Users/user/Desktop/sim_figure/setting2/diff/diff", j, "-", bw, ".png"), width = 500, height = 400)
    if (bw==0){
...
for (j in 1:length(error_sig)){
  ...
  for (bw in 0:3){
    png(paste0("/Users/user/Desktop/sim_figure/setting2/pvalue/pvalue", j, "-", bw, ".png"), width = 400, height = 400)
    if (bw==0){
      contour(seq(0, 1, length.out = sqrt(n_points)), seq(0, 1, length.out = sqrt(n_points)), 
...
for (j in 1:length(error_sig)){
  for (bw in 0:3){
    png(paste0("/Users/user/Desktop/sim_figure/setting2/FPFN/FPFN", j, "-", bw, ".png"), width = 500, height = 400)
    if (bw ==0){
      fp <- false_pos[j,bw+1,]
...
for (j in 1:length(error_sig)){
  ...
  png(paste0("/Users/user/Desktop/sim_figure/setting2/tprs/betafit", j, "-150.png"), width = 500, height = 400)
  ...
  png(paste0("/Users/user/Desktop/sim_figure/setting2/tprs/diff", j,"-150.png"), width = 500, height = 400)
...
levels = c(0.01,0.03,0.05,0.07,0.1,0.2,0.3)
colors = c(rep("black",2), "red", rep("black",4))
...
for (j in 1:length(error_sig)){
  ...
  png(paste0("/Users/user/Desktop/sim_figure/setting2/tprs/pvalue", j, "-150.png"), width = 400, height = 400)
  contour(seq(0, 1, length.out = sqrt(n_points)), seq(0, 1, length.out = sqrt(n_points)), 
          matrix(p_value, nrow = length(seq(0, 1, length.out = sqrt(n_points))), byrow = T), 
